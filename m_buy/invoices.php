        ...
        <div class="container">
            <div class="sells__header">
                ...
                <div class="sells__add">
                    <a href="sells_sort.php">Список товаров на складе</a>
                    <a href="counterparties.php">Список товаров по накладной</a>
                    <a href="s_tovper.php"> Список товаров, поступивших за период</a>
                </div>
